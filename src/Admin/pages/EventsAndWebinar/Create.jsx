...
import { EventWebinarAPI, HandleImagesAPI } from "../../../services/apis";
      ...
      if (videoCode) {
        ...
        if (response && thumbnails) {
          response = await apiConnector({
            method: "POST",
            url: EventWebinarAPI.CreateEventWebinar_API,
            bodyData: {
              ...
              ytb: {
                thumbnailLink: formData.ytbthumbnailLink,
                ytbUrl: videoCode,
              },
            },
          ...
          <div className="flex justify-center items-center w-full max-md:px-4">
            <div className="bg-white p-4 rounded-xl w-[99%] pt-6 pb-12 text-gray-900">
              <form onSubmit={handleSubmit} className="">
                ...
                {/* <div className='mb-4 flex flex-col'>
                  <label htmlFor="ytbthumbnailLink" className='text-sm font-[Poppins] font-[500]'>Youtube Thumbnail</label>
                  <input onChange={changeHandler} autoComplete="ytbthumbnailLink" value={formData.ytbthumbnailLink} name="ytbthumbnailLink" type="text" className='text-sm border-2 border-violet-500 outline-none focus:outline-none rounded-md py-2 px-3 font-[Roboto] tracking-wide mt-1' />
                </div> */}
