      ...
      <div className='3xl:w-[1500px] mx-auto'>
        <div className="w-[100%] mt-16 flex flex-col gap-28">
          <div className="flex flex-col items-center gap-4">
            <h2 className="text-[#1a3777] font-[Rubik] text-5xl font-bold">
              Join Us
            </h2>
            <p className="text-[#000] font-[Roboto] font-semibold">
              Start your Career with MetalogicPMS Today!
            </p>
          </div>

          <div className="w-[100%] flex flex-col gap-4 justify-between items-center py-4 px-8">
            <div className=" flex flex-col items-center gap-4">
              <h2 className="text-[#243b77] font-[Rubik] text-5xl font-bold">
                Featured Roles
              </h2>
              <p className="text-black font-[Rubik] text-sm">
                  ...
                  <>
                    {
                          ...
                          >
                            ...
                            >
                              <div className="flex flex-col gap-2 py-8 px-14">
                                <h2 className="font-[Rubik] font-bold text-[#000] text-2xl">
                                  {d?.position}
                                </h2>
                              ...
                              <div className="w-[100%] flex flex-col justify-around items-start md:flex-row">
                                <div className="flex flex-col gap-2 py-8 md:px-14">
                                  ...
                                  <ul
                                    className="list-disc font-[Rubik] space-y-4 bg-[#1a3777] shadow-2xl p-4 text-white"
                              ...
                              </div>
                              {
                                d?.link &&
                                <button
                                  className="px-14 py-2 ml-8 bg-[#1a3777] text-white rounded-lg text-sm font-[Rubik] mt-8 transition-all duration-300 hover:shadow-lg hover:scale-x-[1.05] animate-bounce"
                                  onClick={() => {
                      ...
                      ) : (<p className="flex items-center justify-center text-center text-4xl font-[Poppins] font-semibold">No Jobs Found</p>)
                    }
                  </>
                )
              }
