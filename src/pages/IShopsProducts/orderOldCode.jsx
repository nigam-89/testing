...
//             {
//                 loading ?
//                     <div className='min-h-[20vh] px-4 md:px-16 py-3 md:py-6 h-full w-full auth_bg relative'>
...
//                                         <div className='flex-1 flex justify-between items-start flex-col gap-4 h-fit'>
...
//                                                 <p className='text-lg font-[Poppins] font-[500] text-gray-900 my-1'>
//                                                     {
...
//                                                     }
//                                                 </p>
//                                                 <p className='text-sm  font-[Poppins] font-[500] text-violet-500 my-1'>
//                                                     {
...
//                                                     }
//                                                 </p>
//                                                 <p className='text-lg font-[Poppins] font-[500] text-gray-900 mt-6 mb-5'>
//                                                     <BsFillLightningChargeFill className='mr-1 text-violet-600 inline text-[0.8rem]' />
//                                                     &#8377;{data?.discountedPrice}
//                                                     <span className='text-base ml-1 text-violet-600 relative before:h-[2px] before:w-full before:absolute before:bg-violet-400 before:top-[0.6rem] before:left-0'> &#8377;{data?.price}</span>
//                                                 </p>
//                                             </div>
