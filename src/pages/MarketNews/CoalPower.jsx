...
const CoalPower = () => {
  ...
  useEffect(() => {
    ...
    const fetchAllYears = async (pageNo = 1, pageSize = 10000, category = "COAL %26 POWER") => {
      try {
  ...
  const handleFilteredData = async (month, year, pageNo = 1, pageSize = 10000, category = "COAL %26 POWER") => {
    ...
    return (
        <div>
            <UpperNavbar />
            <Navbar />
            <StickyHeading img={'https://res.cloudinary.com/djr2f6dlh/image/upload/v1700817392/MyMetalogic/Coal_Power_btq8qd.jpg'} title="Coal & Power" textColor="white" />
