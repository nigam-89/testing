...
const Agriculture = () => {
    ...
    useEffect(() => {
      ...
      const fetchAllYears = async (pageNo = 1, pageSize = 10000, category = "AGRICULTURE") => {
        try {
    ...
    return (
        <div>
            <UpperNavbar />
            <Navbar />
            <StickyHeading img={'https://res.cloudinary.com/djr2f6dlh/image/upload/v1700817391/MyMetalogic/AGRICULTURE_s4etdc.jpg'} title="Agriculture" textColor="white" />
