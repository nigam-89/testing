...
const RenewHydrogen = () => {
  ...
  const admin = useSelector((state) => state.admin)
    ...
    let category = "RENEW %26 HYDROGEN"
    ...
    useEffect(() => {
        ...
        const fetchAllYears = async (pageNo = 1, pageSize = 10000, category = "RENEW %26 HYDROGEN") => {
            try {
      ...
      const handleFilteredData = async (month, year, pageNo = 1, pageSize = 10000, category = "RENEW %26 HYDROGEN") => {
       ...
       return (
        <div>
            <UpperNavbar />
            <Navbar />
            <StickyHeading img={'https://res.cloudinary.com/djr2f6dlh/image/upload/v1700817399/MyMetalogic/RENEW_HYDROGEN_ohncav.jpg'} title="Renew & Hydrogen" textColor="white" />
                    ...
                    <div className='md:max-w-[90%] w-[100%]'>
                        {
                            (user.hasSubscription || admin.token) ? (
                                data.length === 0 ? (<h2 className='text-3xl font-[Rubik] text-center text-gray-700 font-[500] pb-4 tracking-wide mt-20'>No News Found</h2>) : (
                                    dataLoading ? (<h1>Loading</h1>) : data && data?.length > 0 && data[0]?.length > 0 && data[0][0] && (data[0][0]?.newsSource === "INDIA" || data[0][0]?.newsSource === "INTERNATIONAL") &&
                                        ((data?.length > 0) ?
                                            data.map((item, index) => {
                                                return (
                                                    <div className='my-8' key={index}>
                                                        ...
                                                        <div className='flex flex-col md:flex-row justify-start items-start pt-2'>
                                                            ...
                                                            <div className='w-[100%] flex-1 bg-[#243b77] md:min-h-[500px] md:max-h-[500px] overflow-y-auto'>
                                                                <h2 className='text-center font-[Roboto] tracking-widest py-3 text-white mb-2 font-semibold text-lg border-b-[1px]'>INDIA</h2>
                                                            ...
                                                            <div className='w-[100%] flex-1 bg-[#5a5a5a] md:min-h-[500px] md:max-h-[500px] overflow-y-auto'>
                                                                <h2 className='text-center font-[Roboto] tracking-widest py-3 text-white font-semibold text-lg mb-2 border-b-[1px]'>INTERNATIONAL</h2>
                                                                <div className='text-white px-6'>
                                                                    {(
