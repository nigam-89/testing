...
const SteelScrap = () => {
  ...
  useEffect(() => {
    ...
    const fetchAllYears = async (pageNo = 1, pageSize = 10000, category = "STEEL %26 SCRAP") => {
      try {
  ...
  const handleFilteredData = async (month, year, pageNo = 1, pageSize = 10000, category = "STEEL %26 SCRAP") => {
  ...
  return (
    <div>
      <UpperNavbar />
      <Navbar />
      <StickyHeading img={'https://res.cloudinary.com/djr2f6dlh/image/upload/v1700817400/MyMetalogic/Steel_Scrap_jvbih0.jpg'} title="Steel & Scrap" textColor="white" />
