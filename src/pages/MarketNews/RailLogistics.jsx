...
const RailLogistics = () => {
  ...
  let category = "RAIL %26 LOGISTICS"
  ...
  useEffect(() => {
    ...
    const fetchAllYears = async (pageNo = 1, pageSize = 10000, category = "RAIL %26 LOGISTICS") => {
      try {
  ...
  const handleFilteredData = async (month, year) => {
    ...
    return (
        <div>
            <UpperNavbar />
            <Navbar />
            <StickyHeading img={'https://res.cloudinary.com/djr2f6dlh/image/upload/v1700817398/MyMetalogic/RAIL_LOGISTICS_pqxfjc.jpg'} title="Rail & Logistics" textColor="white" />
