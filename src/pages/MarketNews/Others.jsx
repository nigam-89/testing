...
const Others = () => {
    ...
    useEffect(() => {
      ...
      const fetchAllYears = async (pageNo = 1, pageSize = 10000, category = "OTHERS") => {
        try {
    ...
    return (
        <div>
            <UpperNavbar />
            <Navbar />
            <StickyHeading img={'https://res.cloudinary.com/djr2f6dlh/image/upload/v1700817395/MyMetalogic/OTHERs_xklohy.jpg'} title="Other" textColor="white" />
