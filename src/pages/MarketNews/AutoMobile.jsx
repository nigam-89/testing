...
const AutoMobile = () => {
    ...
    useEffect(() => {
      ...
      const fetchAllYears = async (pageNo = 1, pageSize = 10000, category = "AUTOMOBILE") => {
        try {
    ...
    return (
        <div>
            <UpperNavbar />
            <Navbar />
            <StickyHeading img={'https://res.cloudinary.com/djr2f6dlh/image/upload/v1700817391/MyMetalogic/AUTOMOBILE_qqaq1n.jpg'} title="Automobile" textColor="white" />
